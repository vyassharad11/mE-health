...
class BottomSheetFilterAdapter(
    private val mContext: Context, private val itemList: List<FilterItem>
    ...
    override fun onBindViewHolder(holder: BottomSheetFilterAdapter.MyViewHolder, position: Int) {
        ...
        data.let {
            ...
            holder.ivCheckbox.setImageResource(if (it.isChecked) R.drawable.ic_checkbox_active else R.drawable.ic_checkbox_inactive)
